...
function slick_carousel_slider() { 
	// creating (registering) the custom type 
	register_post_type( 'slick_carousel', /* (http://codex.wordpress.org/Function_Reference/register_post_type) */
		// let's now add all the options for this post type
		array( 'labels' => array(
			'name' => __( 'Banner Slider', 'bonestheme' ), /* This is the Title of the Group */
			...
			'description' => __( 'Only show in Homepage template is selected.', 'bonestheme' ), /* Custom Type Description */
			'public' => true,
			...
			'menu_icon' => 'fa-ellipsis-h', /* the icon for the custom post type menu */
			'rewrite'	=> array( 'slug' => 'slick-carousel', 'with_front' => false ), /* you can specify its url slug */
			'has_archive' => 'slick_carousel', /* you can rename the slug here */
	...
	// register_taxonomy_for_object_type( 'category', 'slick_carousel' );
	/* this adds your post tags to your custom post type */
	// register_taxonomy_for_object_type( 'post_tag', 'slick_carousel' );
	
}

// adding the function to the Wordpress init
add_action( 'init', 'slick_carousel_slider');
