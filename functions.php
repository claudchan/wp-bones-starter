...
function bones_fonts() {
	wp_enqueue_style('googleFonts', '//fonts.googleapis.com/css?family=Open+Sans:300,400,600,700,800');
}
...
function theme_register_required_plugins() {
	...
	$plugins = array(
		...
		array(
			'name'               => 'FA WP Admin Menu Icons', // The plugin name.
			'slug'               => 'fa-wp-admin-menu-icons', // The plugin slug (typically the folder name).
			'source'             => 'https://downloads.wordpress.org/plugin/fa-wp-admin-menu-icons.1.0.4.zip', // The plugin source.
			'required'           => true, // If false, the plugin is only 'recommended' instead of required.
			'version'            => '', // E.g. 1.0.0. If set, the active plugin must be this version or higher. If the plugin version is higher than the plugin version installed, the user will be notified to update the plugin.
			'force_activation'   => true, // If true, plugin is activated upon theme activation and cannot be deactivated until theme switch.
			'force_deactivation' => false, // If true, plugin is deactivated upon theme switch, useful for theme-specific plugins.
			'external_url'       => 'https://wordpress.org/plugins/fa-wp-admin-menu-icons/', // If set, overrides default API URL and points to an external URL.
		...
		// 	'source'       => 'https://downloads.wordpress.org/plugin/advanced-custom-fields.4.4.12.zip', // The plugin source.
		// 	'required'     => true, // If false, the plugin is only 'recommended' instead of required.
		// 	'force_activation'   => true, // If true, plugin is activated upon theme activation and cannot be deactivated until theme switch.
		...
		array(
			...
			'required'     => true, // If false, the plugin is only 'recommended' instead of required.
			'force_activation'   => true, // If true, plugin is activated upon theme activation and cannot be deactivated until theme switch.
			'external_url' => 'https://github.com/wp-premium/advanced-custom-fields-pro', // If set, overrides default API URL and points to an external URL.
		),
...
function bootstrap_navbar() {
	wp_nav_menu( array(
		'theme_location'    => 'bootstrap-navbar',
		'depth'             => 2,
		'container'         => 'false',
...
function register_bootstrap_navbar() {
	register_nav_menu('bootstrap-navbar',__( 'Boorstrap Navbar' ));
}

add_action( 'init', 'register_bootstrap_navbar' );
...
function general_settings_register_fields_copyright_message() { 
